...
class Tutor(models.Model):
    ...
    estado_tutor =  models.CharField(max_length=8, choices=ESTADO_OPCIONES, default="Activo")
...
class Alumno(models.Model):
    ...
    estado_alumno =  models.CharField(max_length=8, choices=ESTADO_OPCIONES, default="Activo")
